...
while True:
    ...
    # Köpfe sammeln für Vernetzung: head hat aktuellen Positionen der "Köpfe" (der oberste Punkt jeder Person).
    heads = []
...
# statements:
# wenn abstand größer ist: linie löschen 


# linie immer neu berechnen: so schenll, dass man das nicht sieht 